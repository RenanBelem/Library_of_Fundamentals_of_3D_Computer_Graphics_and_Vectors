...
Vetor v1(1, 100.0f, 100.0f, 100.0f), v2(2, 50.0f ,80.0f ,20.0f), v3(3, 0.0f, 0.0f, 0.0f);
...
void render() {
	...
	cor("BRANCO");
	v1.Desenha(0, 0, 0);          // desenha o vetor 1 em (0,0,0) 
	cor("AZUL");
	v2.Desenha(100, 100, 100);    // desenha o vetor 2 em (100,100,100) 

	v3 = v3.Soma2Vetores(v1, v2); // vetor 3 recebe a soma de v1 e v2
	cor("AMARELO");
	v3.Desenha(0, 0, 0);          // desenha vetor 3 em (0,0,0)
// ---------------------------------------------------------------------------------- //
	cor("BRANCO");
	v1.Desenha(100, 0, 0);          // desenha o vetor 1 em (100,0,0) 
	cor("AZUL");
	v2.Desenha(100, 0, 0);      // desenha o vetor 2 em (100,0,0) 

	v3 = v3.Subtrai2Vetores(v1, v2); // vetor 3 recebe a soma de v1 e v2
	cor("AMARELO");
	v3.Desenha(150, 80, 20);             // desenha vetor 3 em (50+100,80,20)
