...
TetraHedro th(1, 0.0f, -60.0f, -60.0f, 25.0f);
Cone cone(1, 35.0f, -25.0f, -5.0f, 15.0f);
Disk disk(1, -65.0f, 2.0f, 0.0f, 15.0f);
Cube cube(1, 25.0f, 25.0f, 0.0f, -10.0f);

typedef tuple<TetraHedro, Cone, Disk, Cube> tp;

tp t1 = make_tuple(th, cone, disk, cube);


char title[] = "OpenGL ILUMINAÇÃO TETRAHEDRO  NORMAIS";
