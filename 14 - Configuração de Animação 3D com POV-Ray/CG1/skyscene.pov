...
#declare Camera_0 = camera{ angle 80 
                            ...
                            location  <0.1*clock*-2.2 , 1.0 ,-3.0>
                            look_at   <0.0 , 2.0 , 0.0>}
camera{Camera_0}
//fontes de luz
...
//esferas
sphere{ <0,0,0>, 0.2 scale <1,1.5,1>
        texture { pigment{ rgb<1,1,1> }
                  finish { diffuse 0.9
                           phong 1}
                } // end of texture
        translate < 4.0, 2.5*clock*0.2, 2.0>    
        rotate <-30, -0, 0> 
...
sphere{ <0,0,0>, 0.4 scale <1,1.5,1>
        ...
        translate < 1.5, 2.5*clock*0.4, 2.0>    
        rotate <-30, 0, 0> 
        //rotate < 0,360*clock,0>//  <-!!!!
       } // end of sphere ---------------  
       
      
sphere{ <0,0,0>, 0.3 scale <1,1.5,1>
        texture { pigment{ rgb<0,0,1> }
                  finish { diffuse 0.9
                           phong 1}
                } // end of texture
        translate < -1.5, 1.5*clock*0.3, 3.0>    
        rotate <-30, 0, 0> 
        //rotate < 0,360*clock,0>//  <-!!!!
       } // end of sphere ---------------  