...
#include "App/VetoresApp/ClasseVetor.cpp"
//#include "Vetores.cpp"
...
void grid() {
	...
	for (int i = -nRange; i <= +nRange; i = i + 100) {
	...
	glutWireCube(2.0f * nRange); // volume de vilsualização
}
...
void render() {
	...
	float x = posicao.xcomp;
	float y = posicao.ycomp;
	float z = posicao.zcomp;

	float x1 = -posicao.xcomp;
	float y1 = posicao.ycomp;
	float z1 = -posicao.zcomp;
...
int main(int argc, char** argv) {
	...
	glutInitWindowPosition(50.0f, 50.0f);   // Position the window's initial top-left corner
